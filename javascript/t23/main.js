...
users_table.innerHTML = users_sand;
}
drawUsers()
   ...
   myModal.innerHTML = `
		...
		<div class="modal-content">
		  ...
		  <div class="modal-footer">
			...
			<a class="btn btn-sm btn-success" href="https://www.google.com.ua/maps/@${user.address.geo.lng},${user.address.geo.lat},13.12z">Показати на карті</a>
